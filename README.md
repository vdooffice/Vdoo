...
Vdoo Integration/Staging Tree
================================

**Copyright (c) 2017-2018 Vdoo**
...
This will build Vdoo-Qt as well if the dependencies are met.
...
memory available when compiling Vdoo Core. With 512MB of memory or less
...
If you want to build Vdoo-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a Vdoo-Qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip Vdood" to strip the debug
...
Security
--------
To help make your Vdoo installation more secure by making certain attacks impossible to
