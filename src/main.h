...
static const unsigned int MAX_BLOCK_SIZE = 82000000;
...
inline int64_t GetMNCollateral(int nHeight) { return 500000; } // *COIN is added with usage implements
...
public:
	...
	int64_t GetPastTimeLimitV2() const
	{
