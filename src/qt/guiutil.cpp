...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Vdoo.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Vdoo-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  Vdoo-Qt [" + tr("command-line options") + "]                     " + "\n";
