...
It is possible to run Vdoo as a Tor hidden service, and connect to such services.
...
1. Run Vdoo behind a Tor proxy
---------------------------------

The first step is running Vdoo behind a Tor proxy. This will already make all
...
In a typical situation, this suffices to run behind a Tor proxy:
  ...
  ./Vdood -proxy=127.0.0.1:9050


2. Run a Vdoo hidden server
------------------------------
...
your Vdood's P2P listen port (17170 by default).
...
In a typical situation, where you're only reachable via Tor, this should suffice:
  ...
  ./Vdood -proxy=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -listen
...
for normal IPv4/IPv6 communication, use:
  ...
  ./Vdood -tor=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -discover
